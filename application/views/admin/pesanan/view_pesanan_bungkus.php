  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        ?>
        <li class=""><a href="<?php echo base_url() ?>apesanan/keluar">Keluar <i class="fa fa-sign-out"></i></a></li>
      </ul>
...
<?php if ($this->db->where(array('tgl' => date('Y-m-d')))->get('q_pesan_bungkus')->num_rows() == 0) { ?>
<div class="row">
	<div class="jumbotron">
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<h1 align="center" style="color:#359e8e"><b>PESANAN BAWA PULANG</b></h1>
	</div>
</div>
<div class="row">
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
		<div class="x_panel" id="pos" pos="<?php echo $pos; ?>">
			<div class="x_title" id="jml">
				<div class="col-md-12">
				<!-- <div>
	                <a href="<?php echo base_url() ?>apesanan/selesaibungkus/<?php echo $brs->nota ?>" id="btnpos" class="btn btn-block btn-success">Selesai</a>
	            </div> -->
	            </div>
			...
			<div class="x_content">
				...
				<p align="center"><font size="1pt">Atas Nama </font><b><?php echo $brs->nama ?></b></p>
					<div class="table-responsive">
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<?php
									$jml = 0;
									$det =$this->db->group_by('item')->get_where('q_pesan_bungkus',array('nota' => $brs->nota ,'sts_item'=>'belum' ));
									foreach ($det->result() as $row) { 
										
									?>
								<tr>
									<td><a href="<?php echo base_url() ?>apesanan/selesaibksbarang/<?php echo $brs->nota ?>/<?php echo $row->kd_item ?>" id="btnpos" class="btn"><i class="fa fa-check"></i></a></td>
