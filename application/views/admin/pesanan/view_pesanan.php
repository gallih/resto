...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<h4 align="center" style="color:#333333;">Divisi Makanan</h4>
	</div>
</div>
<div class="row">
	...
	<div class="col-md-4 col-sm-6 col-xs-12">
		<div class="x_panel" id="pos" pos="<?php echo $pos; ?>">
			<div class="x_title" id="jml">
				<div class="col-md-12">
				<!-- <div>
	                <a href="<?php echo base_url() ?>apesanan/selesai/<?php echo $brs->nota ?>" id="btnpos" class="btn btn-block btn-success">Selesai  <span class="badge"><?php echo $pos ?></span></a>
	            </div> -->
	            </div>
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<?php
									...
									?>
								<tr>
									<td><a href="<?php echo base_url() ?>apesanan/selesaibarang/<?php echo $brs->nota ?>/<?php echo $row->kd_item ?>" class="btn btn-success"><i class="fa fa-check"></i></a></td>
