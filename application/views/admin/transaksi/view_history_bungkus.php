...
<div class="row">
<h3 align="center"><i class="fa fa-caret-right"></i> History Pemesanan <b class="label-info" style="color:#fff">Bawa Pulang</b> Hari ini</h3>
<div class="col-md-6 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title" style="background:#a0364f;color:#fff">
            <h2 align="center">PESANAN <span style="color:#000"><b>PENDING</b></span></h2>
...
<div class="col-md-6 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title" style="background:#1d916c;color:#fff">
            <h2 align="center">PESANAN <span style="color:#a0364f"><b>SUDAH SELESAI</b></span></h2>
            <div class="clearfix"></div>
        </div>
        <div class="">
